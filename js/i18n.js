...
const translations = {
    en: {
        ...
        locations: {
            ...
            giza: {
                ...
                address:
                    "Central Axis Road, Sheikh Zayed\nGiza, Egypt",
        ...
        validation: {
            ...
            nameTooLong:
                "Your name must not exceed 50 characters.",

            invalidName:
                "Your name contains invalid characters.",

            emailTooLong:
                "Your email address must not exceed 100 characters.",
            ...
            dateTooFar:
                "Bookings can only be made up to one year in advance.",
        ...
        journal: {
            ...
            posts: {
                ...
                2: {
                    title:
                        "Where Your Coffee Comes From: A Journey to Origin",
                ...
                4: {
                    title:
                        "5 Coffee-Inspired Desserts to Try This Weekend",
                ...
                6: {
                    title:
                        "Meet the Roaster: Behind Our House Blend",
                ...
                7: {
                    title:
                        "A Beginner's Guide to Espresso at Home",
                ...
                9: {
                    title:
                        "From Bean to Cup: How We Reduce Waste",
        ...
        about: {
            ...
            storyParagraph1: "We strive to form profound partnerships with farmers from all over the world to create perspective together and form healthy working relationships built on trust and respect.",
            storyParagraph2: "An exceptional experience starts with only the best ingredients, handled with absolute care from seed to cup.",
            philosophyTitle: "From Seed to Cup",
            philosophyDescription: "Discover our selection of organic, sustainably-sourced products",
            card1Title: "01. Sustainable Sourcing",
            card1Description: "Working closely with local and international partners to ensure ethical and high-quality harvesting.",
            card2Title: "02. Expert Craftsmanship",
            card2Description: "Every step of the process is carefully monitored by experts to maintain rich and authentic flavors.",
            card3Title: "03. Passion & Soul",
            card3Description: "Dedicated to delivering excellence and building a long-lasting relationship of trust with our community.",
            ctaTitle: "We'd love to hear from you!",
            ctaDescription: "Whether it's feedback or if you want to join our lovely team.",
        ...
        faq: {
            ...
            question7:
                "Do you offer Certified Organic and Fair Trade coffees?",
        ...
        meta: {
            ...
            signUpTitle:
                "Coffee Shop ☕ |Create Account ",

            accountTitle:
                "Coffee Shop ☕ | My Account  ",
    ...
    ar: {
        ...
        home: {
            ...
            benefitSocialDescription:
                "أو اشترك في نشرتنا البريدية للبقاء على اطلاع.",
        ...
        locations: {
            ...
            giza: {
                ...
                address:
                    "طريق المحور المركزي، الشيخ زايد\nالجيزة، مصر",
        ...
        validation: {
            ...
            emailTooLong:
                "يجب ألا يزيد البريد الإلكتروني عن 100 حرف.",

            dateRequired:
                "من فضلك اختر التاريخ.",

            dateInPast:
                "من فضلك اختر تاريخ اليوم أو تاريخًا مستقبليًا.",

            dateTooFar:
                "يمكن إجراء الحجوزات بحد أقصى قبل سنة واحدة.",

            peopleRequired:
                "من فضلك أدخل عدد الأشخاص.",

            peopleNotInteger:
                "يجب أن يكون عدد الأشخاص رقمًا صحيحًا.",

            peopleOutOfRange:
                "يجب أن يكون عدد الأشخاص بين 1 و10.",

            messageTooShort:
                "يجب أن تحتوي الرسالة على 10 أحرف على الأقل.",

            messageTooLong:
                "يجب ألا تزيد الرسالة عن 500 حرف."
        },
        ...
        journal: {
            ...
            subscribeSuccess:
                "تم الاشتراك بنجاح في النشرة البريدية لمقهى القهوة!",
            ...
            posts: {
                1: {
                    title:
                        "فن تحضير القهوة بالتقطير المثالي",
                ...
                2: {
                    title:
                        "من أين تأتي قهوتك؟ رحلة إلى المصدر",
                ...
                3: {
                    title:
                        "كولد برو أم قهوة مثلجة: ما الفرق؟",
                ...
                4: {
                    title:
                        "5 حلويات مستوحاة من القهوة لتجربتها هذا الأسبوع",
                ...
                6: {
                    title:
                        "تعرف على المحمّص: خلف مزيجنا الخاص",
                ...
                7: {
                    title:
                        "دليل المبتدئين لتحضير الإسبريسو في المنزل",
                ...
                9: {
                    title:
                        "من الحبة إلى الكوب: كيف نقلل الهدر",
        ...
        faq: {
            ...
            question1:
                "ما طرق تحضير القهوة التي توصي بها؟",
            ...
            question5:
                "هل يمكنني الحصول على فاتورة لطلبي؟",
            ...
            question7:
                "هل توفرون قهوة عضوية معتمدة وقهوة التجارة العادلة؟",
        ...
        meta: {
            signInTitle:
                "Coffee Shop ☕ | تسجيل الدخول",

            signUpTitle:
                "Coffee Shop ☕ | إنشاء حساب",
